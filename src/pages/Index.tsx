...
import {
  ...
  MapPin, Megaphone, Share2, RefreshCw
} from "lucide-react";
...
const ppcServices = [
  { icon: Megaphone, title: "Google Ads Management", desc: "Search, Display, Shopping & YouTube campaigns expertly managed to maximize your return on ad spend.", href: "/ppc/google-ads-management" },
  { icon: Share2, title: "Social Media Ads", desc: "Targeted ad campaigns across Facebook, Instagram, LinkedIn & TikTok that engage and convert.", href: "/ppc/social-media-ads" },
  { icon: RefreshCw, title: "Remarketing & Retargeting", desc: "Bring back lost visitors with personalized ads that drive conversions at lower cost.", href: "/ppc/remarketing-retargeting" },
];
        ...
        <div className="container mx-auto">
          ...
          <div className="text-center mt-10">
            <Link to="/services">
              <Button variant="outline" size="lg">
                All SEO Services <ArrowRight className="ml-2 h-4 w-4" />
              </Button>
            </Link>
          </div>
          ...
          <div className="mt-20">
            <div className="text-center max-w-2xl mx-auto mb-12">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">
                PPC & Paid <span className="text-gradient">Advertising</span>
              </h2>
              <p className="text-muted-foreground">Need immediate results? Our PPC services drive instant, measurable traffic and conversions.</p>
            </div>
