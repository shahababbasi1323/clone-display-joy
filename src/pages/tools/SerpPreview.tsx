      ...
      <section className="section-padding">
        <div className="container mx-auto max-w-4xl">
          <h1 className="text-3xl md:text-4xl font-bold mb-2">
            Google SERP <span className="text-gradient">Preview</span>
          </h1>
          <p className="text-muted-foreground mb-8">See exactly how your page will appear in Google search results.</p>
            ...
            <div className="space-y-4">
              <div>
                <label className="text-sm font-medium mb-1.5 flex justify-between">
                  <span>Title Tag</span>
                  <span className={`${titleLen > 60 ? "text-destructive" : titleLen > 50 ? "text-accent" : "text-muted-foreground"}`}>
                    {titleLen}/60
                  </span>
                </label>
              ...
              <div>
                <label className="text-sm font-medium mb-1.5 flex justify-between">
                  ...
                  <span className={`${descLen > 160 ? "text-destructive" : descLen > 140 ? "text-accent" : "text-muted-foreground"}`}>
                    {descLen}/160
                  </span>
                </label>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="rounded-xl border border-border bg-background p-5">
                  <p className="text-primary text-xl leading-snug hover:underline cursor-pointer truncate">
                  ...
                  <p className="text-muted-foreground text-sm mt-2 line-clamp-2 leading-relaxed">
                    {description || "Your meta description will appear here. Write a compelling description to improve click-through rates."}
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <span className="text-muted-foreground">
                    Title: {titleLen === 0 ? "Empty" : titleLen <= 60 ? "Good length" : "Too long"}
                  </span>
                </div>
                <div className="flex items-center gap-2 text-sm">
                  <div className={`w-2 h-2 rounded-full ${descLen === 0 ? "bg-muted-foreground" : descLen <= 160 ? "bg-accent" : "bg-destructive"}`} />
                  <span className="text-muted-foreground">
                    Description: {descLen === 0 ? "Empty" : descLen <= 160 ? "Good length" : "Too long"}
                  </span>
                </div>
              </div>
            </div>
