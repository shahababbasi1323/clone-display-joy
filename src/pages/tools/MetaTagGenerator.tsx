      ...
      <section className="section-padding">
        <div className="container mx-auto max-w-4xl">
          <h1 className="text-3xl md:text-4xl font-bold mb-2">
            Meta Tag <span className="text-gradient">Generator</span>
          </h1>
          <p className="text-muted-foreground mb-8">Generate SEO-optimized meta tags for your website pages.</p>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="space-y-4">
              <div>
                <label className="text-sm font-medium mb-1.5 block">
                  Page Title <span className="text-muted-foreground">({title.length}/60)</span>
                </label>
              ...
              <div>
                <label className="text-sm font-medium mb-1.5 block">
                  Meta Description <span className="text-muted-foreground">({description.length}/160)</span>
                </label>
            ...
            <div>
              ...
              <pre className="glass rounded-xl p-4 text-xs leading-relaxed overflow-auto max-h-[400px] whitespace-pre-wrap">
                {output}
              </pre>
              ...
              {(title || description) && (
                <div className="mt-6">
                  ...
                  <div className="bg-background rounded-xl p-4 border border-border">
                    ...
                    <p className="text-muted-foreground text-sm mt-1 line-clamp-2">{description || "Page description will appear here..."}</p>
                  </div>
                </div>
              )}
            </div>
