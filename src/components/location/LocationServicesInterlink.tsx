...
const serviceLabels: Record<string, Record<string, { title: string; desc: string }>> = {
  ...
  da: {
    "technical-seo": { title: "Teknisk SEO", desc: "Siteaudit, hastighed, Core Web Vitals og crawl-rettelser" },
    "on-page-seo": { title: "On-Page SEO", desc: "Indholdsoptimering, meta-tags, interne links og sidestruktur" },
    "link-building": { title: "Linkbuilding", desc: "Kvalitetsbacklinks, outreach og gæsteindlæg" },
    "local-seo": { title: "Lokal SEO", desc: "Google Virksomhedsprofil, lokale citater og anmeldelsesstyring" },
    "ecommerce-seo": { title: "E-handel SEO", desc: "Optimering af produkt- og kategorisider til webshops" },
    "geo-optimization": { title: "GEO-Optimering", desc: "Synlighed i AI-søgemaskiner som ChatGPT og Perplexity" },
    "content-strategy": { title: "Indholdsstrategi", desc: "Indholdsproduktion, redaktionel planlægning og content marketing" },
    "seo-consulting": { title: "SEO-Rådgivning", desc: "Konkurrentanalyse, roadmap og teamtræning" },
    "keyword-research": { title: "Søgeordsanalyse", desc: "Keyword-analyse, konkurrentgab og søgeintention" },
    "schema-markup": { title: "Schema Markup", desc: "Strukturerede data JSON-LD, rich snippets og FAQ Schema" },
    "website-speed-optimization": { title: "Hastighedsoptimering", desc: "Webperformance, lazy loading og billedoptimering" },
    "international-seo": { title: "International SEO", desc: "Hreflang, flersproget indhold og geografisk målretning" },
  },
  sv: {
    "technical-seo": { title: "Teknisk SEO", desc: "Webbplatsaudit, hastighet, Core Web Vitals och crawl-fixar" },
    "on-page-seo": { title: "On-Page SEO", desc: "Innehållsoptimering, metataggar, interna länkar och sidstruktur" },
    "link-building": { title: "Länkbyggande", desc: "Kvalitetslänkar, outreach och gästinlägg" },
    "local-seo": { title: "Lokal SEO", desc: "Google Företagsprofil, lokala citeringar och recensionshantering" },
    "ecommerce-seo": { title: "E-handel SEO", desc: "Optimering av produkt- och kategorisidor för webbutiker" },
    "geo-optimization": { title: "GEO-Optimering", desc: "Synlighet i AI-sökmotorer som ChatGPT och Perplexity" },
    "content-strategy": { title: "Innehållsstrategi", desc: "Innehållsproduktion, redaktionell planering och content marketing" },
    "seo-consulting": { title: "SEO-Rådgivning", desc: "Konkurrentanalys, roadmap och teamutbildning" },
    "keyword-research": { title: "Sökordsanalys", desc: "Nyckelordsanalys, konkurrentgap och sökintention" },
    "schema-markup": { title: "Schema Markup", desc: "Strukturerade data JSON-LD, rich snippets och FAQ Schema" },
    "website-speed-optimization": { title: "Hastighetsoptimering", desc: "Webbprestanda, lazy loading och bildoptimering" },
    "international-seo": { title: "Internationell SEO", desc: "Hreflang, flerspråkigt innehåll och geografisk inriktning" },
  },
  no: {
    "technical-seo": { title: "Teknisk SEO", desc: "Nettstedsrevisjon, hastighet, Core Web Vitals og crawl-fikser" },
    "on-page-seo": { title: "On-Page SEO", desc: "Innholdsoptimalisering, metatagger, interne lenker og sidestruktur" },
    "link-building": { title: "Lenkebygging", desc: "Kvalitetslenker, outreach og gjesteposter" },
    "local-seo": { title: "Lokal SEO", desc: "Google Bedriftsprofil, lokale siteringer og anmeldelseshåndtering" },
    "ecommerce-seo": { title: "E-handel SEO", desc: "Optimalisering av produkt- og kategorisider for nettbutikker" },
    "geo-optimization": { title: "GEO-Optimalisering", desc: "Synlighet i AI-søkemotorer som ChatGPT og Perplexity" },
    "content-strategy": { title: "Innholdsstrategi", desc: "Innholdsproduksjon, redaksjonell planlegging og innholdsmarkedsføring" },
    "seo-consulting": { title: "SEO-Rådgivning", desc: "Konkurranseanalyse, veikart og teamopplæring" },
    "keyword-research": { title: "Søkeordsanalyse", desc: "Nøkkelordanalyse, konkurransegap og søkeintensjoner" },
    "schema-markup": { title: "Schema Markup", desc: "Strukturerte data JSON-LD, rich snippets og FAQ Schema" },
    "website-speed-optimization": { title: "Hastighetsoptimalisering", desc: "Nettytelse, lazy loading og bildeoptimalisering" },
    "international-seo": { title: "Internasjonal SEO", desc: "Hreflang, flerspråklig innhold og geografisk målretting" },
  },
  fi: {
    "technical-seo": { title: "Tekninen SEO", desc: "Sivustoauditointi, nopeus, Core Web Vitals ja indeksoinnin korjaukset" },
    "on-page-seo": { title: "On-Page SEO", desc: "Sisällön optimointi, metatagit, sisäiset linkit ja sivurakenne" },
    "link-building": { title: "Linkkien rakentaminen", desc: "Laadukkaat takalinkit, yhteydenotot ja vieraskirjoitukset" },
    "local-seo": { title: "Paikallinen SEO", desc: "Google Yritysprofiili, paikalliset viittaukset ja arvosteluhallinta" },
    "ecommerce-seo": { title: "Verkkokauppa-SEO", desc: "Tuote- ja kategoriasivujen optimointi verkkokaupoille" },
    "geo-optimization": { title: "GEO-optimointi", desc: "Näkyvyys tekoälyhakukoneissa kuten ChatGPT ja Perplexity" },
    "content-strategy": { title: "Sisältöstrategia", desc: "Sisällöntuotanto, toimituksellinen suunnittelu ja sisältömarkkinointi" },
    "seo-consulting": { title: "SEO-konsultointi", desc: "Kilpailija-analyysi, tiekartta ja tiimikoulutus" },
    "keyword-research": { title: "Avainsanatutkimus", desc: "Avainsana-analyysi, kilpailijapuutteet ja hakutarkoitus" },
    "schema-markup": { title: "Schema Markup", desc: "Rakenteellinen data JSON-LD, rich snippets ja FAQ Schema" },
    "website-speed-optimization": { title: "Nopeusoptimointi", desc: "Verkkosivujen suorituskyky, lazy loading ja kuvaoptimointi" },
    "international-seo": { title: "Kansainvälinen SEO", desc: "Hreflang, monikielinen sisältö ja maantieteellinen kohdentaminen" },
  },
};
