...
const navLinks = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Islamabad", href: "/seo-services-islamabad" },
      { label: "Karachi", href: "/seo-services-karachi" },
      { label: "Lahore", href: "/seo-services-lahore" },
      { label: "🇦🇪 UAE", group: true },
      { label: "Dubai", href: "/seo-services-dubai" },
      { label: "Abu Dhabi", href: "/seo-services-abu-dhabi" },
      { label: "🇬🇧 United Kingdom", group: true },
      { label: "London", href: "/seo-services-london" },
      { label: "Manchester", href: "/seo-services-manchester" },
      { label: "🇺🇸 United States", group: true },
      { label: "New York", href: "/seo-services-new-york" },
      { label: "Los Angeles", href: "/seo-services-los-angeles" },
